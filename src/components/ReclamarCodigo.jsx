...
const ReclamarCodigo = ({ userId }) => {
    ...
    const handleReclamar = async (event) => {
        ...
        try {
            const response = await fetch('https://detodito-back.vercel.app/v1/margarita/reclamar', {
                method: 'POST',
                headers: {
    ...
    const obtenerHistorial = async (userId) => {
        try {
            const response = await fetch(`https://detodito-back.vercel.app/v1/margarita/historial/${userId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
